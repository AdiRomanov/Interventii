...
public class ChimicaleFolosite extends Entity{
    ...
    public ChimicaleFolosite(Integer id, Integer idInterventie, float clorGranule, float clorTablete, float clorLichid,
                     float phGranule, float phLichid, float antialgic, float anticalcar, float floculant, float sare, float bicarbonat) {
        super(id);
        this.idInterventie = idInterventie;
        this.clorGranule = clorGranule;
        this.clorTablete = clorTablete;
